...
export default useName({
  ...
  render () {
    ...
    const start = <div class="ymu-slider__hd">{ this.$slots.start }</div>
    const end =  <div class="ymu-slider__ft">{ this.$slots.end }</div>
    return (
      <div class="ymu-slider" class={cls}>
        { this.$slots.start ? start : null }
        <div class="ymu-slider__bd" ref="content" style={this.contentStyle}>
          <div class="ymu-slider__runway" ref="runway" style={this.runwayStyle}></div>
          <div class="ymu-slider__track" ref="track" style={this.trackStyle}></div>
          <div
            class="ymu-slider__thumb"
            style={{ left: this.ratio, backgroundColor: this.thumbColor }}
            v-on:touchstart="onTouchStart"
            v-on:touchmove="onTouchMove"
            v-on:touchend="onTouchEnd"></div>
        </div>
